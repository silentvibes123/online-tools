...
async function handlePrint() {
  ...
  win.document.write(`<html><body style="font-family:Arial;padding:20px"><h2>iLoveFastTools - Cash Receipt</h2><hr><table border="1" cellpadding="8" style="width:100%;border-collapse:collapse"><tr><th>Note</th><th>Count</th><th>Total</th></tr>${rows}<tr><td colspan="2"><b>Grand Total</b></td><td><b>₹${total}</b></td></tr></table><br><p>Generated by iLoveFastTools</p></body></html>`);
...
function showExtra(page) {
  ...
  document.title = (titles[page]||page) + " | iLoveFastTools";
  ...
  const pages = {
    about: `<h2 class="fw-bold text-primary mb-3 border-bottom pb-2">About iLoveFastTools</h2>
      <p class="lead text-muted">iLoveFastTools is a free, browser-based digital toolkit built for students, professionals, and everyday users across India.</p>
      <h5 class="fw-bold mt-4">Our Story</h5>
      <p>iLoveFastTools was created with one simple goal — to give every Indian internet user access to powerful digital tools without paying a rupee, without creating an account, and without worrying about their private files being uploaded to unknown servers.</p>
      <p>Whether you're a student preparing for SSC or UPSC exams who needs to resize a photo to exactly 20KB, a small business owner who needs to calculate GST quickly, or a developer who needs a Base64 encoder — iLoveFastTools has you covered.</p>
      <h5 class="fw-bold mt-4">What Makes Us Different</h5>
      <p>Unlike most online tools that upload your files to their servers, <strong>iLoveFastTools processes everything locally in your browser</strong>. Your PDFs, images, and documents never leave your device. This means complete privacy, faster processing, and zero risk of data leaks.</p>
      ...
      <p>iLoveFastTools currently offers 23+ free tools across four categories:</p>
      <ul>
      ...
      <p class="mt-3 text-muted small">iLoveFastTools is maintained independently and supported by advertising revenue through Google AdSense. This allows us to keep all tools free for everyone.</p>`,

    privacy: `<h2 class="fw-bold mb-3 border-bottom pb-2">Privacy Policy</h2>
      <p class="small text-muted">Last Updated: March 2026</p>
      <p>iLoveFastTools ("we", "our", or "us") is committed to protecting your privacy. This policy explains how we handle information when you use our website at <strong>iLoveFastTools.com</strong>.</p>

      <h5 class="fw-bold mt-4 text-primary">1. No File Storage — Zero Server Uploads</h5>
      <p>iLoveFastTools uses 100% client-side processing. When you use any of our tools (PDF converter, image resizer, OCR, etc.), your files are processed entirely within your browser's memory. <strong>No file is ever uploaded to our servers.</strong> When you close the tab, all data is cleared automatically.</p>
      ...
      <p>iLoveFastTools does not knowingly collect any personal information from children under 13 years of age.</p>
    ...
    terms: `<h2 class="fw-bold mb-3 border-bottom pb-2">Terms of Service</h2>
      <p class="small text-muted">Last Updated: March 2026</p>
      <p>Please read these Terms of Service carefully before using iLoveFastTools at <strong>iLoveFastTools.com</strong>.</p>

      <h5 class="fw-bold mt-4 text-primary">1. Acceptance of Terms</h5>
      <p>By accessing or using iLoveFastTools, you agree to be bound by these Terms of Service. If you do not agree to these terms, please do not use our website.</p>

      <h5 class="fw-bold mt-4 text-primary">2. Description of Service</h5>
      <p>iLoveFastTools provides free, browser-based digital utility tools including PDF tools, image tools, finance calculators, and utility tools. All tools are provided free of charge and process data locally in your browser.</p>

      <h5 class="fw-bold mt-4 text-primary">3. Acceptable Use</h5>
      <p>You agree to use iLoveFastTools only for lawful purposes. You must not use our tools to:</p>
      <ul>
      ...
      <p>The iLoveFastTools name, logo, design, and original content are owned by iLoveFastTools. Third-party libraries used (PDF.js, Tesseract.js, etc.) are subject to their respective open-source licenses.</p>

      <h5 class="fw-bold mt-4 text-primary">5. Disclaimer of Warranties</h5>
      <p>iLoveFastTools is provided "as is" without any warranties of any kind. We do not guarantee that our tools will produce results accepted by third-party portals (such as government exam websites). Always verify output before submission.</p>

      <h5 class="fw-bold mt-4 text-primary">6. Limitation of Liability</h5>
      <p>iLoveFastTools shall not be liable for any direct, indirect, incidental, or consequential damages arising from your use of our tools or inability to use our tools.</p>

      <h5 class="fw-bold mt-4 text-primary">7. Advertising</h5>
      <p>iLoveFastTools displays advertisements through Google AdSense to support the free service. By using our website, you consent to the display of these advertisements.</p>
